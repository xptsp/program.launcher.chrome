...
# Var to hold  the path where the FireFox executable is
executable = ""
...
if platform.system() == "Windows":
    ...
    # Otherwise it is Linux because FireFox currently runs on Windows, Debians and RetroPie
...
if not os.path.isfile(executable):
    # This message prints something like: FireFox executable was not found, go to Addon-Configure and change it
    ...
    # This message prints something like: Please check that FireFox is installed
    xbmcgui.Dialog().ok(__localizedMessages__(32004), __localizedMessages__(32005))
    # Log the error
    log("FireFox executable was not found on this specified location: " + executable, xbmc.LOGERROR)
    ...
    log("Starting FireFox executable: " + executable)
